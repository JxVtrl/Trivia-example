...
export function Question ({ question, answers, correct }) {
  ...
  function verifyAnswer (event) {
    if (removeSpecialChars(event.target.innerText) === removeSpecialChars(correct)) {
      ...
      document.querySelectorAll('.list')[questionNum].childNodes
        .forEach(item => {
          if (removeSpecialChars(item.innerText) === removeSpecialChars(correct)) {
